...
const Applicant: React.FC = () => {
  ...
  const job = applicant ? jobs.find(j => j.id === applicant.jobId) : null;
  ...
  return (
    <div className="container-fluid py-4">
      <div className="mb-4">
        <Link to={`/applicants/${job.id}`} className="btn btn-link text-decoration-none p-0 mb-3">
      ...
      <div className="row">
              ...
              <div className="card border-0 shadow-sm h-100">
                <div className="card-body">
                  ...
                  <div className="row mb-2">
                    ...
                    <div className="col-sm-7 fw-bold">{job.title}</div>
                  </div>
                  <div className="row mb-2">
                    <div className="col-sm-5 text-muted">Experience:</div>
                    <div className="col-sm-7">{job.experience} required</div>
                  </div>
                  <div className="row">
                    <div className="col-sm-5 text-muted">Rounds:</div>
                    <div className="col-sm-7">{job.interviewRounds} interview rounds</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="col-lg-4">
          ...
          <div className="card border-0 shadow-sm">
            ...
            <div className="card-body">
              <div className="mb-3">
                <strong className="text-muted">Experience:</strong> {job.experience}
              </div>
              <div className="mb-3">
                <strong className="text-muted">Openings:</strong> {job.openings}
              </div>
              <div className="mb-4">
                <strong className="text-muted">Rounds:</strong> {job.interviewRounds}
              </div>
